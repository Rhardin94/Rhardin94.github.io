  ...
  function projectSwap() {
    ...
    const pastProjects = [
      fridge2Table = {
        ...
        deployed: $("<a href='https://expo.io/@rhardin/fridgetotable?release-channel=prod' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed App </h4>"),
        repo: $("<a href='https://github.com/Dreadpipe/fridge2table' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo</h4>")
      },
      clickEmDead = {
        ...
        deployed: $("<a href='https://rhardin94.github.io/ClickEmDead/' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed Site </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/ClickEmDead' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo</h4>")
      },
      PipPip_Newsio = {
        ...
        deployed: $("<a href='https://dry-mesa-18962.herokuapp.com/' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed Site </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/PipPip_Newsio/tree/master' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo</h4>")
      },
      moviews = {
        ...
        deployed: $("<a href='https://moviews-team5.herokuapp.com/' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed Site </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/Moviews' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo </h4>")
      },
      burgerMeister = {
        ...
        deployed: $("<a href='https://stark-forest-59222.herokuapp.com/' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed Site </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/Burger_Meister' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo </h4>")
      },
      bamazonApp = {
        ...
        deployed: $("<a href='https://drive.google.com/file/d/1Y4ZtCnFz6rCUDe69aqrM64HyLaljF393/view?usp=sharing' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Demo </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/Bamazon_NOT_Amazon' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo </h4>")
      },
      liriApp = {
        ...
        deployed: $("<a href='https://drive.google.com/file/d/1TDuus6k-dMUWgKzbpJ6GsKnQ-r6s4B18/view' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Demo </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/Liri-Node-App' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo </h4>")
      },
      nerdLator = {
        ...
        deployed: $("<a href='https://rhardin94.github.io/Nerd-Lator/' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed Site </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/Nerd-Lator' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo </h4>")
      },
      gifTastic = {
        ...
        deployed: $("<a href='https://rhardin94.github.io/GifTastic/' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed Site </h4>"),
        repo: $("<a href='https://github.com/Rhardin94/GifTastic' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo </h4>")
      },
      officeTrivia = {
        ...
        deployed: $("<a href='https://rhardin94.github.io/Office-Trivia/' target='_blank'>").html("<h4 class=' projectLink animated pulse slow infinite'> Link to Deployed Site"),
        repo: $("<a href='https://github.com/Rhardin94/Office-Trivia' target='_blank'>").html("<h4 class=' projectLink fab fa-github animated pulse slow infinite'> Repo </h4>")
      }
    ];
    ...
    for (let i = 0; i < pastProjects.length; i++) {
      ...
      const currentProject = $("<div>").attr("class", "col-lg-4 project p-3 m-1 d-inline-block animated fadeIn slow");
